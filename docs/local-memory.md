...
| `export` | [`docs/export-for-substack.md`](export-for-substack.md) | Absolute markdown projection only (Substack + X Article); MacDown preview paste; no HTML / RTF export paths |
