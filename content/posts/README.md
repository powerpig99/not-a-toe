...
export/<slug>.md                 # Substack absolute-link markdown only (gitignored)
...
|---------|------|----------------|
| Substack | After live, if posting there | [`docs/export-for-substack.md`](../../docs/export-for-substack.md) · `node scripts/export-absolute-md.mjs <slug>` → `export/<slug>.md` |
...
7. [ ] If posting to Substack: after live, `node scripts/export-absolute-md.mjs <slug>` ([`docs/export-for-substack.md`](../../docs/export-for-substack.md)).
...
- If cross-links are added later, re-export absolute markdown only if you will update Substack by hand.
