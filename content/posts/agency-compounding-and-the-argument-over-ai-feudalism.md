...
1. Instead of optimizing the quality of their next real-world action against physical feedback, they optimize their relative standing against visible peers;
2. Attention shifts from objective error correction to monitoring rivals, defending status, and interpreting others' gains as personal losses;
3. The internal feedback signal becomes overwhelmed by social noise;
4. The learning rate drops, and the improvement slope (`m`) flattens toward zero.
