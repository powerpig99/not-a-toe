...
The tool amplifies capability only at the moment of use. Whether that increment is used as a reason to improve raw capability, or as a reason not to, depends on the individual’s choice — the relation to the tool, not the tool. Generating the finished solution and asking for help in figuring it out are those two relations. The empirical pattern revealed by the homework–exam inversion is real. The interpretation that treats the instrument as the causal agent relocates the choice.
