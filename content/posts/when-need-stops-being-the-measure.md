...
Between centers there is only availability-patterning. No parent completes the child’s return; no child’s continued dependence completes the parent’s interior. [No Universal Salvation, Only Self-Deliverance](../mei-you-pu-du-zhi-you-zi-du/) is that bound without isolation as program: traces may be taken up or not; cross-locus completion of another’s recursion is a category error. The parent who requires need in order to feel that care succeeded is asking the child’s compulsion to ratify what only the parent’s own edge can register. The parent who can receive chosen association without requiring it restores locus: the child’s freedom stays at the child’s center; association, if it arrives, is resonance, not proof of essential place.
