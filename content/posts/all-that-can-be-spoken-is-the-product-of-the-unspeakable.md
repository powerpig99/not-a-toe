...
graph TD
    ...
    subgraph S_Wittgenstein ["【维特根斯坦的倒置：本体错置与因果颠倒】"]
        direction TB
        W1["本体错置：将观察与言说的产物当作基底"]:::failure
        W2["因果颠倒：工具表达受限反被裁决为源头应沉默"]:::failure
        W3["虚无代价：若不言说则不可言说沦为空洞幻影"]:::failure
        W1 --> W2 --> W3
    end

    subgraph S_Reconstruction ["【认识论翻转：言说显化不可言说之源头】"]
        direction TB
        R1["非物观察者：必须通过观察与言说体现存在"]:::mind
        R2["言说即确证：凡可言说模型皆为生成的脚手架"]:::scaffold
        R3["拒绝沉默：在真实摩擦中坚定试图说得更好"]:::mind
        R1 --> R2 --> R3
    end

    W3 ===>|"认识论纠偏：打破沉默，言说确证非物源头"| R1
...
graph TD
    ...
    subgraph S_Wittgenstein_EN ["Wittgenstein's Inversion: Ontological Displacement & Causal Reversal"]
        direction TB
        WE1["Ontological Displacement: Treating Products of Observation as Substrate"]:::failure
        WE2["Causal Inversion: Tool Expressive Limits Used to Mandate Silence"]:::failure
        WE3["Vacuous Abdication: Without Speaking the Unspeakable Becomes Void"]:::failure
        WE1 --> WE2 --> WE3
    end

    subgraph S_Reconstruction_EN ["Epistemological Reversal: Discourse Manifests the Unspeakable"]
        direction TB
        RE1["Non-Object Observer: Existence Validated Through Distinguishing"]:::mind
    ...
    WE3 ===>|"Epistemological Correction: Overturning Inversion to Manifest Agency"| RE1
