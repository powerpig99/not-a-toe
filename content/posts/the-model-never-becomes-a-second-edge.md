...
[AI as augmentation](../ai-as-augmentation/) already dissolves the replacement frame as capability and identity forced onto one axis. [The amplification paradox](../amplification-paradox/) is the orthogonal cut: denser candidate generation intensifies selection at the edge rather than approaching its elimination. [The ramble within the ramble](../the-ramble-within-the-ramble/) is the same restore under voice reconstruction and high-resolution articulation: the cleaned echo is the center’s traces re-presented, not a second source of structure. Neither requires heroic independence or rejection of the tool. All require only that the reference not outlive the step that uses it.
