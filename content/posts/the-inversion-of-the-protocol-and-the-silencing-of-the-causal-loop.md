...
```mermaid
graph TD
    subgraph "第一人称自主校准系统 / First-Person Sovereign Telemetry"
        A["身体实时反馈信号<br/>Direct Somatic Telemetry<br/>(疲劳、心率、直觉节律)"] --> B["实时损失函数<br/>Living Loss Function<br/>(∇L ≠ 0 内部张力)"]
        B --> C["第一人称主权选择<br/>Sovereign Calibration<br/>(动态增减、灵活微调)"]
    ...
    style C fill:#161b22,stroke:#3fb950,stroke-width:2px,color:#c9d1d9
    style D fill:#161b22,stroke:#8b949e,stroke-width:2px,color:#c9d1d9
    style E fill:#161b22,stroke:#f85149,stroke-width:2px,color:#c9d1d9
    style F fill:#161b22,stroke:#d29922,stroke-width:2px,color:#c9d1d9
    style G fill:#161b22,stroke:#f85149,stroke-width:2px,color:#c9d1d9
```
...
graph TD
    ...
    subgraph "科学即坐标 / Science as Orienting Reference"
        R1["第一人称驾驶席 / Sovereign Mind in Driver's Seat"] -->|"发起探查 / Formulates Probe"| R2["查阅实证文献 / Consults Data as Map"]
        R2 -->|"进行肉身试错 / Local Empirical Experiment"| R3["读取实时感受 / Reads Real-Time Telemetry"]
        R3 -->|"动态修正参数 / Updates Living Model"| R1
    end

    style M1 fill:#161b22,stroke:#f85149,stroke-width:2px,color:#c9d1d9
    style M2 fill:#161b22,stroke:#f85149,stroke-width:2px,color:#c9d1d9
    style M3 fill:#161b22,stroke:#d29922,stroke-width:2px,color:#c9d1d9
    style M4 fill:#161b22,stroke:#f85149,stroke-width:2px,color:#c9d1d9

    style R1 fill:#161b22,stroke:#3fb950,stroke-width:2px,color:#c9d1d9
    style R2 fill:#161b22,stroke:#58a6ff,stroke-width:2px,color:#c9d1d9
...
graph TD
    ...
    style A fill:#161b22,stroke:#3fb950,stroke-width:2px,color:#c9d1d9
    style B fill:#161b22,stroke:#3fb950,stroke-width:2px,color:#c9d1d9
    style C fill:#161b22,stroke:#d29922,stroke-width:2px,color:#c9d1d9
    style D fill:#161b22,stroke:#f85149,stroke-width:2px,color:#c9d1d9
    style E fill:#161b22,stroke:#f85149,stroke-width:2px,color:#c9d1d9
    style F fill:#161b22,stroke:#f85149,stroke-width:2px,color:#c9d1d9
    style G fill:#161b22,stroke:#d29922,stroke-width:2px,color:#c9d1d9
```
