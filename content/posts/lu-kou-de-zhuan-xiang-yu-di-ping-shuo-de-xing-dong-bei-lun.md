...
[The Mark and the Act](../the-mark-and-the-act/) 与 [Climbing does not leave the ground](../climbing-does-not-leave-the-ground/) 确立了行动与地面的因果位阶：**在真实世界中胜出的，不是执着于理论完美性的空想家，而是懂得根据地形匹配工具的主体——在有航线的地方善用飞机，在没有航线的荒野中立即迈开双脚、在物理摩擦中持续纠偏前行**。你不需要在迈出第一步之前就拥有无懈可击的全局真理；只要你始终在真实的物理摩擦中根据反馈校准动作，现实本身的因果铁律就会推着你向前演化。
