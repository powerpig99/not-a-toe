...
None of this argues against benchmarks. It returns them to one-step width: instruments for sealed problem classes, re-rendered when the edge has moved, never installed as exhaustive reality of capability. Progress under a shared instrument remains real where sequence tracks that instrument. Direction remains registration by centers complex enough to track sequence — including centers building games, servers, and systems that either run or do not.
