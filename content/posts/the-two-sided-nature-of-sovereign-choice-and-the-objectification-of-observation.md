...
```mermaid
graph TD
    subgraph S_Internal["【第一人称内在视角：二元掌控】"]
        direction TB
        I1["立足当下时刻（t）"]
    ...
    subgraph S_External["【第三人称外在视角：不确定性表象】"]
        direction TB
        E1["跨越平行宇宙边界观察他者"]
        E2["无法读取内在模型，仅能捕捉外在行动轨迹"]
        E3["表现为不可预测的随机性与量子测不准效应"]
        E1 --> E2 --> E3
    end

    I2 <===>|"双面同构：自由抉择的外在投影即是随机表象"| E2

    style S_Internal fill:#161b22,stroke:#3fb950,stroke-width:1px,color:#3fb950
    style S_External fill:#161b22,stroke:#58a6ff,stroke-width:1px,color:#58a6ff
    style I1 fill:#0d1117,stroke:#3fb950,stroke-width:1px,color:#c9d1d9
    style I2 fill:#0d1117,stroke:#3fb950,stroke-width:1px,color:#c9d1d9
    style I3 fill:#0d1117,stroke:#3fb950,stroke-width:1px,color:#c9d1d9
...
graph TD
    ...
    style S_Micro fill:#161b22,stroke:#3fb950,stroke-width:1px,color:#3fb950
    style S_Macro fill:#161b22,stroke:#58a6ff,stroke-width:1px,color:#58a6ff
    style S_Fallacy fill:#161b22,stroke:#f85149,stroke-width:1px,color:#f85149
    style M1 fill:#0d1117,stroke:#3fb950,stroke-width:1px,color:#c9d1d9
    style M2 fill:#0d1117,stroke:#3fb950,stroke-width:1px,color:#c9d1d9
    style M3 fill:#0d1117,stroke:#3fb950,stroke-width:1px,color:#c9d1d9
    style D1 fill:#0d1117,stroke:#58a6ff,stroke-width:1px,color:#c9d1d9
    style D2 fill:#0d1117,stroke:#58a6ff,stroke-width:1px,color:#c9d1d9
    style D3 fill:#0d1117,stroke:#58a6ff,stroke-width:1px,color:#c9d1d9
...
graph TD
    ...
    subgraph S_PowerLaw["【长期宏观表象：幂律涌现】"]
        direction TB
    ...
    style S_Static fill:#161b22,stroke:#58a6ff,stroke-width:1px,color:#58a6ff
    style S_Dynamic fill:#161b22,stroke:#3fb950,stroke-width:1px,color:#3fb950
    style S_PowerLaw fill:#161b22,stroke:#d29922,stroke-width:1px,color:#d29922
    style N1 fill:#0d1117,stroke:#58a6ff,stroke-width:1px,color:#c9d1d9
    style N2 fill:#0d1117,stroke:#58a6ff,stroke-width:1px,color:#c9d1d9
    style C1 fill:#0d1117,stroke:#3fb950,stroke-width:1px,color:#c9d1d9
    style C2 fill:#0d1117,stroke:#3fb950,stroke-width:1px,color:#c9d1d9
    style C3 fill:#0d1117,stroke:#3fb950,stroke-width:1px,color:#c9d1d9
...
```mermaid
graph TD
    subgraph S_Para["【平行宇宙流形：自指心智】"]
        direction TB
        P_A["【心智 A：自指宇宙 A】<br>拥有自身宇宙内的‘上帝视角’<br>观察心智 B 作为自身决策的参考坐标"]
        P_B["【心智 B：自指宇宙 B】<br>拥有自身宇宙内的‘上帝视角’<br>观察心智 A 作为自身决策的参考坐标"]
    end

    subgraph S_Resonance["【共振与客观性的客体化】"]
        direction TB
        R1["群体心智产生集体认知共振"]
        R2["投射出一个悬浮于外部的‘外在上帝 / 客观真相’"]
        R3["迷思：将主观观察的‘客体化过程’误作独立于心智的客观实体"]
        R1 --> R2 --> R3
    end

    P_A <===>|"相互观察作为参考，无法直接修改对方模型"| P_B
    P_A -.->|"向外投射"| R1
    P_B -.->|"向外投射"| R1

    style S_Para fill:#161b22,stroke:#3fb950,stroke-width:1px,color:#3fb950
    style S_Resonance fill:#161b22,stroke:#f85149,stroke-width:1px,color:#f85149
    style P_A fill:#0d1117,stroke:#3fb950,stroke-width:1px,color:#c9d1d9
    style P_B fill:#0d1117,stroke:#3fb950,stroke-width:1px,color:#c9d1d9
    ...
    style R3 fill:#0d1117,stroke:#f85149,stroke-width:1px,color:#c9d1d9
```
