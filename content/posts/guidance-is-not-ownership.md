...
## The Pathologized Adolescent and the Stanford Voice Study

A well-known Stanford neuroimaging study on voice processing offers a revealing window into this diagnostic distortion: around age thirteen, a young person's neural reward and social-valuation circuitry transitions from responding preferentially to a mother's voice to responding more strongly to unfamiliar voices.

The neurobiological measurement is real; the causal attribution is backward.

The study describes a natural sensory recalibration toward the wider world—the cognitive apparatus expanding its observational horizon to incorporate external terrain. Yet conventional discourse immediately pathologizes this shift, converting a healthy developmental milestone into evidence of adolescent defect. 
...
The fundamental ontological reality precedes adolescence: **every conscious mind is the sole, non-transferable author of its own selections**.

In early childhood, incomplete physical strength, narrower knowledge, and immature impulse regulation necessitate parental protection and instruction. But physical vulnerability and epistemic asymmetry do not, under any circumstance, transfer the child's will into the possession of the parent:

* A parent can lift a toddler away from a hot stove;
* A parent can structure the physical menu of available foods;
* A parent can restrict access to hazardous environments.
...
As explored in [Emotional support as causal interference](../emotional-support-as-causal-interference/), attempting to externally regulate another agent's decisions cuts the feedback loop that produces internal responsibility. When parent–child friction becomes chronic and destructive, the failure lies entirely in the governance model: the parent has overstepped from environmental boundary setting into an illegitimate usurpation of the child's agency.

## The Error of Relocating Agency: Social Hierarchies and Institutional Illusions
...
Rejecting deterministic agency-relocation is not a naive claim that choice operates in an unconstrained vacuum. Every decision is made inside non-negotiable physical, biological, and social limits: biological endowments, historical momentum, fear, power imbalances, and available cognitive bandwidth.
