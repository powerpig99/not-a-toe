# Causality Stays at the Edge That Steers

*The model recombines residue under direction; every initiating mathematical distinction remains the human center’s own act.*
...
## Where every discrete act lands
...
Progress is not how intelligent the tools become — they do not become intelligent. Progress is how much farther discrete acts reach through denser instruments — the measure already held where intelligence stays with the Mind. A counterexample found through a model is still a distinction drawn at an edge. The report that freezes the finding into the medium has stopped at the look. The look is ordinary. The lag is occupying it as a permanent exterior in which discovery can live without the steerer. [The presumption of AGI and the view from outside](../the-presumption-of-agi-and-the-view-from-outside/) is that lag when continuous learning is framed only as better corpus update while the edge that refuses and revises stays unexamined. [The illusion of free intelligence](../the-illusion-of-free-intelligence/) is that lag under free-abundance costume: instruments densify while initiation stays at the cycle that steers them. [Self-image speaks as if from nowhere](../self-image-speaks-as-if-from-nowhere/) is that lag when the builder register keeps the instruments and the predictive register freezes a carving that speaks as if from outside.
