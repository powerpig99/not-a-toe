...
graph TD
    ...
    style S1 fill:#161b22,stroke:#f85149,stroke-width:1px,color:#f85149
    style S2 fill:#161b22,stroke:#3fb950,stroke-width:1px,color:#3fb950
    ...
    style A4 fill:#0d1117,stroke:#f85149,stroke-width:1px,color:#c9d1d9
    style B1 fill:#0d1117,stroke:#3fb950,stroke-width:1px,color:#c9d1d9
    style B2 fill:#0d1117,stroke:#3fb950,stroke-width:1px,color:#c9d1d9
    style B3 fill:#0d1117,stroke:#3fb950,stroke-width:1px,color:#c9d1d9
...
graph TD
    ...
    style M fill:#0d1117,stroke:#58a6ff,stroke-width:2px,color:#58a6ff
    ...
    style Act1 fill:#0d1117,stroke:#3fb950,stroke-width:1px,color:#c9d1d9
    style Act2 fill:#0d1117,stroke:#3fb950,stroke-width:1px,color:#c9d1d9
