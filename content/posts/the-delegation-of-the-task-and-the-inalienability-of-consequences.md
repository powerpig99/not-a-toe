...
在主权主体调用工具的实践中，“委托”一词常常招致严重的混淆。常见的偏颇频频预设了一种未经审视的前提，即把人和工具放在了等同的主体地位，甚至用“对等协作”来形容人与器物的关系。正如在 [智能只属于心智](../intelligence-belongs-only-to-the-mind/)、[造物无法取代造物者](../a-creation-cannot-replace-its-source/) 与 [造神的障眼法与隐秘阶序的说辞](../the-sleight-of-hand-of-synthesizing-gods-and-unacknowledged-rank/) 中所确立的：**工具从未与人类“协作”，更遑论成为淘汰人类的继承者；工具始终是主体算力与感知能力的延伸和杠杆，在因果链条中不可逆地处于被调用的从属位置。** 任务的移交在计算与操作维度上并没有既定的静态上限，但任何移交都断然不可脱离具体情境下的动态约束制定。正如我们在 [框架的倒置与驾驶位的主权非对称](../the-inversion-of-the-harness-and-the-driver-seat-asymmetry/) 中所剖析的，一旦使用者将方向盘与油门让渡给从属辅助系统，便会在认知倒置中跌落驾驶席的主权地位。
