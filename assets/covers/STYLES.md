...
| **Radar PPI phosphor residual still** | Dark instrument console, circular CRT scope, bright green phosphor ring only at outer perimeter, residual afterglow trails dissolving toward center, scan-line grain, matte metal bezel, cool side light | `residual-control-recedes-to-the-edge` |
...
| `residual-control-recedes-to-the-edge` | Radar PPI phosphor residual still |
