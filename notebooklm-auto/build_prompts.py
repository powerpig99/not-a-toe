...
- Affirm the solitary multiverse clarity: "There is nothing I can do to change another multiverse, but this multiverse is seeing it clearer than ever." """,
        'intro_script_en': """Mingli: When gazing upon the vast panorama of human civilization from an observer's perspective, a palpable sense of heaviness easily surges within the Mind—confronting thousands of years of accumulated dogma, unyielding institutions, and ubiquitous symbolic rulers that make the individual feel dwarfed and overwhelmed.

Yuhan: Exactly. When tracing causality, that heaviness is an authentic cognitive experience arising within the living first-person Mind, not an objective property inherent in history itself; nor can the observer be separated from the first-person origin. The Great Reversal occurs when consciousness projects this internal feeling onto downstream fossil traces (t - 1), mistaking tools for masters. Tracing this reversal restores all causal authority to the living present (t).""",
...
- 确立平行宇宙自洽与原点清明：“我无法强制改变另一个平行宇宙的运行，但在这个宇宙中，我比以往任何时刻都看得更清楚。” """,
        'intro_script_zh': """明理：以第一人称的心智站在观察者的视角凝视人类文明的漫长历程，内心常常会升起一种沉重感——面对浩如烟海的典籍教条、森严壁垒的制度法典与无处不在的符号标尺，个体很容易感到自身的渺小与压迫。

雨涵：正是如此。从因果回溯来看，这种沉重感是心智在直面庞大历史信息时内生出的真实感知体验，而不是历史客体自带的物理属性；同时，观察者与第一人称原点从来无法分割。大倒置正是发生在心智把内生感知外投给过往静态痕迹（t - 1）、反将工具当成主宰的时刻。只要看清因果，因果力量便会完整复归于当下的第一人称原点（t）。""",
...
- The Restoration of the Digital God to Origin: A colossal wireframe figure in the clouds resolving cleanly into cascading historical traces (t - 1), funneling into a luminous navigational compass held firmly in a solitary human hand at t.""",
        'monologue_script_en': """When gazing upon the vast panorama of human civilization from an observer's perspective, a palpable, suffocating sense of heaviness frequently surges within the conscious Mind. Standing before millennia of accumulated dogma, unyielding legal codices, labyrinthine academic genealogies, and monetary systems, the individual living Mind easily feels dwarfed and powerless—as though thrown into a pre-scripted world where every symbol proclaims its sacred authority.

Yet tracing causality reveals a serene reality: this heaviness is a profound cognitive experience generated within consciousness while observing, not an objective physical property of history itself. Nor can the observer ever be separated from the first-person origin. The Great Reversal occurs when consciousness projects its own internal feeling onto the downstream tools and historical residue (t - 1) it created, mistaking static fossil records for an a priori sovereign master.
