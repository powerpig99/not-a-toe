# Multi-Platform Publishing Copy Templates

This document defines the canonical, minimalist, emoji-free templates for publishing summaries across **Spotify**, **WeChat Channels (微信视频号)**, and **X (Twitter)**.

---

## 1. Universal Standards & Constraints
...
### A. Spotify Podcast (Chinese)

**Title Format**:
```text
EP{{EPISODE_NUMBER}}｜{{CORE_TITLE_ZH}}
```

**Description Format**:
```text
{{PARAGRAPH_1: The opening hook, tension, and living metaphor/thought experiment}}

{{PARAGRAPH_2: The epistemological mechanism, human realignment, and sovereignty reclamation in multi-agent reality}}
...
### B. Spotify Podcast (English)

**Title Format**:
```text
EP{{EPISODE_NUMBER}} | {{CORE_TITLE_EN}}
```

**Description Format**:
```text
{{PARAGRAPH_1: The opening hook, core philosophical tension, and foundational thought experiment}}

{{PARAGRAPH_2: The epistemological mechanism, human realignment, and reclaiming agency in multi-agent reality}}

Full essay: https://powerpig99.github.io/not-a-toe/posts/{{SLUG}}/
```
...
**Caption Format**:
```text
{{PARAGRAPH_1: 现象切入与引人深思的直击开场}}

{{PARAGRAPH_2: 人造物/工具与活态心智的边界划定，破除神化或恐慌迷思}}
...
**Format**:
```text
{{OPENING_THESIS: Single piercing thesis statement exposing the core fallacy}}

{{PARAGRAPH_1: Deconstruction of the cultural or technical illusion using a concrete thought experiment}}

{{PARAGRAPH_2: The epistemological boundary between inert artifacts and living conscious minds}}

{{PARAGRAPH_3: The evolutionary ultimatum in multi-agent reality and the reclamation of first-person agency}}
...
### Spotify (ZH)
**Title**:
EP322｜框架的倒置与驾驶位的主权非对称

**Description**:
面对软件工程界对AI智能体“控制框架”的普遍焦虑，人们习惯于将系统的确定性寄托在更精密的测试脚手架与规则沙箱之上，却忽视了一个核心定律：当使用者将自身的第一人称因果主权让渡给工具时，任何原本强大的能力都会在瞬间反向变成限制视界的认知天花板。这种主权的让渡不仅发生在使用外部框架时，更隐蔽地发生在使用“过去自我”所写的旧脚本与工作流中。昨天的最佳实践是昨天特定情境下的局部最优投影；一旦边界条件迁移，让新现实削足适履地迁就旧工具，昔日的解题能力就异化为了当下的认知牢笼。
...
**Caption**:
软件工程界正在为AI智能体的“控制框架”陷入集体焦虑，试图用更复杂的规则与测试沙箱圈禁概率模型。但这里的认识论盲区在于：当使用者让渡第一人称掌控权时，任何强大的能力都会反向异化为囚禁自身的牢笼。
