...
function renderAbout() {
  return `    <section class="about" id="about">
      ...
      <p>我无法替任何人应对现实或解决问题——每一个拥有主权的心智都需要自己去探索并显化属于自己的道路。我所能做的最真诚的交付，唯有分享自己探寻因果原点的这条心路，作为其他探寻者找寻自身原点的一份参照与火花。纳瓦尔（Naval Ravikant）曾说，他一直乐于分享，但成名之前无人问津。我深同其前感，却对后者毫无挂怀。若有人想寻求关于“如何获得成功”的建议，我无可奉告；但若有人渴望探寻属于自己的因果原点，我随时倾囊相授。这里没有费用、公式或咨询服务。若有人在交流中体会到价值，他们可以在任何觉得真诚的时刻、以任何形式予以回馈——亦可不做任何回馈。我之所以敞开，仅仅是因为主权心智之间的真诚共鸣，会共同照亮意识那片无需外求的本底。</p>
