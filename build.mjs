...
function renderAbout() {
  return `    <section class="about" id="about">
      ...
      <p>Alongside the ontology I am building <strong>Ontos</strong> — a different kind of agent: method ground plus regenerable practice, not a persona pack or a scoreboard-maxing harness. It is designed for open-ended problem-solving under real encounter — figure out a path, act, re-trace, and compound through deliberate renewal — while sovereignty remains with the operator’s Mind. Ontos is a super instrument for that locus, never a relocation of intelligence into the tool. The prototype is open at the <a href="https://github.com/powerpig99/ontos" rel="noopener noreferrer">Ontos</a> repository.</p>
      ...
      <p>I maintain the foundational work openly under the MIT license for maximum sharing — free to use, modify, and redistribute — see the <a href="https://github.com/powerpig99/ontological-clarity" rel="noopener noreferrer">Ontological Clarity</a> repository and the <a href="https://github.com/powerpig99/ontos" rel="noopener noreferrer">Ontos</a> agent chassis. Shared artifacts claim no credit and bear no responsibility for how others choose to adapt or apply them. The collection of posts on this site is scaffolding left by live tracing with the Ontological Clarity Framework — densified residue kept close to the edge, never the tracing itself — open for continuous re-rendering. Some may call it open source. I call it open trace: the source is the Mind — the edge that keeps moving, always at least one step ahead.</p>
