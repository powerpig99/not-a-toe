...
function renderAbout() {
  return `    <section class="about" id="about">
      ...
      <p>I maintain the foundational work openly under a Creative Commons license so it remains free to use and adapt — see the <a href="https://github.com/powerpig99/ontological-clarity" rel="noopener noreferrer">Ontological Clarity</a> repository. Everything I share is a frozen scaffolding at a point in time, not live tracing; it claims no credit and bears no responsibility for how others choose to adapt or apply it. I also share the evolving framework through carefully curated long posts on a broad range of topics.</p>
