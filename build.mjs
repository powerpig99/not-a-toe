...
function renderAbout() {
  return `    <section class="about" id="about">
      ...
      <p>I maintain the foundational work openly under the MIT license for maximum sharing — free to use, modify, and redistribute — see the <a href="https://github.com/powerpig99/ontological-clarity" rel="noopener noreferrer">Ontological Clarity</a> repository and the <a href="https://github.com/powerpig99/ontos" rel="noopener noreferrer">Ontos</a> agent chassis. Shared artifacts claim no credit and bear no responsibility for how others choose to adapt or apply them. The collection of posts on this site is still scaffolding left by live tracing with the Ontological Clarity Framework — not the tracing itself — kept open for revision.</p>
