...
function renderAbout() {
  return `    <section class="about" id="about">
      ...
      <p>I maintain the foundational work openly under the MIT license for maximum sharing — free to use, modify, and redistribute — see the <a href="https://github.com/powerpig99/ontological-clarity" rel="noopener noreferrer">Ontological Clarity</a> repository. A repository snapshot is scaffolding at a point in time; it claims no credit and bears no responsibility for how others choose to adapt or apply it. The collection of posts on this site is different: living samples of live tracing with the Ontological Clarity Framework — always open for revision.</p>
