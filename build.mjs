...
function renderAbout() {
  return `    <section class="about" id="about">
      ...
      <p>I sometimes apply the framework with others navigating complex, high-stakes situations. Rather than offering prescriptive answers or solving problems on their behalf, I demonstrate how to trace causal roots and dissolve cognitive entanglements, enabling them to build and trust their own navigational capability. There is no fee. If someone finds value in the exchange, they may reciprocate in whatever form and timing feels authentic — or not at all. I engage where the interaction deepens first-principles clarity; I value genuine positive-sum resonance across sovereign minds.</p>
